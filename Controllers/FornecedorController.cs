...
namespace Atimo.Controllers
{
    ...
    public class FornecedorController : Controller
    {
        ...
        {
            return View(_db.PESSOA.Where(p => p.FORNECEDOR == 1).ToList());
        }
        ...
        {
            var existe = _db.PESSOA.Any(x => x.NUM_DOC == pessoa.NUM_DOC && x.TIPO == "F");
        ...
        public ActionResult Edit(PESSOA pessoa)
        {
            var existe = _db
                .PESSOA
                .Any(x => x.NUM_DOC == pessoa.NUM_DOC && x.TIPO == "F" && x.ID != pessoa.ID);
