...
(function($){
	...
	$.ajax_upload = function(button, options){
		...
		if (button.length != 1 ){
		    console.error('You passed ', button.length, ' elements to ajax_upload at once');
			return false;
		}
	...
	Ajax_upload.prototype = {
		...
		create_input : function(){
		    ...
		    //Set specific File Extensions
			if (self.settings.fileExtensions != '') {
			    this.input.attr('accept', self.settings.fileExtensions);
			}
		...
		submit: function () {
		    ...
		    //iframe.load(function(){ //Alterado para compatibilidade com jQuery 3.x
